...
def lookup_project_id(name):
    """Return the project's ID with the given name. If not found raise exception."""
    dict = _get_projects()
...
def get_projects_stories(project, story):
    """Return the details and comments of a particular story."""
    path = API_PATH_PREFIX
    path +='/projects/' + str(project) + '/stories/' + str(story)
